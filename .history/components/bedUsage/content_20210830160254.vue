      ...
      >
        <div v-for="(data, index) in dataArry" :key="data.id">
          <div
            ...
            @click="show(index)"
          >
            <p class="mb-2 text-md font-medium text-white text-center text-lg">{{ data.prefecture_name }}</p>
            <p class="text-sm font-normal text-white text-center">{{ data.use_bed_rate_hospitalization }}%</p>
