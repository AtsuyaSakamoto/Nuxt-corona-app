<template>
  <div>
    ...
    <p class="hover:text-red-800"><a href="https://www.stopcovid19.jp/">療養状況等及び入院患者受入病床数等に関するデータ情報提供:新型コロナウイルス対策ダッシュボード</a></p>
    <p class="mt-2 hover:text-red-800">療養状況等及び入院患者受入病床数等に関する調査についての元データ情報提供:厚生労働省</p>
