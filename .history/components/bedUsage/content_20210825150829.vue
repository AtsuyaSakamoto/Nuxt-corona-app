<template>
  <div>
    ...
    <div class="text-white m-5 py-9 underline text-xs text-center md:text-base hover:text-red focus:ring-purple-600">
    <p><a href="https://www.stopcovid19.jp/">療養状況等及び入院患者受入病床数等に関するデータ情報提供:新型コロナウイルス対策ダッシュボード</a></p>
    <p class="mt-2">療養状況等及び入院患者受入病床数等に関する調査についての元データ情報提供:厚生労働省</p>
