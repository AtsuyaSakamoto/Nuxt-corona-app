<template>
  <div>
    ...
    <div class="text-white m-5 pt-11 text-xs text-center">

    </div>
    <p class="text-white m-5 pt-11 text-xs text-center">療養状況等及び入院患者受入病床数等に関する調査についてのJSONデータ情報提供:新型コロナウイルス対策ダッシュボード</p>
    <p class=" text-white m-5 pb-20 text-xs text-center md:text-sm">療養状況等及び入院患者受入病床数等に関する調査についてのJSONデータ情報提供:新型コロナウイルス対策ダッシュボード</p>
  </div>
</template>
<script>
