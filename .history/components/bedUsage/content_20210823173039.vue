<template>
<div class="m-10 border-2 border-gray-200 bg-white mx-52">
    <h1 class="text-center m-5 text-xl">都道府県別病床使用率(データ更新日：{{dataArry[0].updateDate}})</h1>
<div class="flex items-center justify-center">
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6">
        <div v-for="(data, index) in dataArry" :key="index">

        <div class="relative bg-white py-2 px-2 rounded-xl w-64 my-1"
