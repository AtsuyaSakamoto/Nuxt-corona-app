<template>
  <div>
    ...
    <div class="text-white m-5 py-9 underline text-xs text-center md:text-base hover:text-red-800">
    <p class-""><a href="https://www.stopcovid19.jp/">療養状況等及び入院患者受入病床数等に関するデータ情報提供:新型コロナウイルス対策ダッシュボード</a></p>
