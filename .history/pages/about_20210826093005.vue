...
<div class="bg-gray-900">
  ...
  <div class="bg-red-100 shadow-md p-5 rounded lg:w-30  mx-36 pt-10">
    ...
    <h2 class="text-xl mb-3 font-bold">ブラウザについて</h2>
    <p class="mb-3">
      当サイトでは、Google Chrome（最新版）での閲覧を推奨しております。
      その他のブラウザでの閲覧に関しては正常に動作しない可能性があります。
    </p>
    <h2 class="text-xl mb-3 font-bold">JavaScriptについて</h2>
    <p class="mb-3">
    ...
    <h2 class="text-xl mb-3 font-bold">本サイトで利用しているデータについて</h2>
    <p>本サイトでは、以下一覧が提供されているデータを利用しています。</p>
    <br />
    <ul class="underline text-blue-600">
      <li class="hover:text-blue-900 mb-1">
        <a
      ...
      <li class="hover:text-blue-900 mb-1">
        <a href="https://corona.go.jp/dashboard/" target="_blank">
      ...
      <li class="hover:text-blue-900 mb-1">
        <a href="https://corona.go.jp/dashboard/" target="_blank">
          ※DATA:CC BY/新型コロナウイルス対策ダッシュボード提供：対策病床使用率
        </a>
      </li>
      <li class="hover:text-blue-900 mb-1">
        <a href="https://corona.go.jp/dashboard/" target="_blank">
          ※DATA:CC BY/新型コロナウイルス対策ダッシュボード提供：PCR検査陽性率
        </a>
      </li>
      <li class="hover:text-blue-900 mb-1">
        <a href="https://www.stopcovid19.jp/" target="_blank">
          ※DATA:CC
    ...
    <br />
    データについては、下記リンク先に記載の事項を確認した上で非営利目的で利用しています。<br />
    ...
    <br />
    <h2 class="text-xl mt-3 font-bold">更新情報</h2>
