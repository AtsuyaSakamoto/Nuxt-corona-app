            ...
            <div class="MuiGrid-root MuiGrid-container MuiGrid-spacing-xs-2">
              ...
              >
                ...
                >
                  ...
                  <h2 style="font-size: 40px">
                    {{
                      Math.round(
                        (usebed.reduce((a, b) => a + Number(b['入院者数']), 0) /
                          usebed.reduce(
                            (a, b) => a + Number(b['入院患者受入即応病床数']),
                            0
                          )) *
                          10000
                      ) / 100
                ...
                >
                  <div>
                    ...
                    <h3 style="font-size: 24px">
                      前日比：{{
                        corona[corona.length - 1]['npatients'] -
                        corona[corona.length - 2]['npatients']
                      }}
                      ＋人
                    </h3>
                    <h3 style="font-size: 24px">
                      前々日比：{{
                        corona[corona.length - 1]['npatients'] -
                        corona[corona.length - 3]['npatients']
                      }}
                      ＋人
                    </h3>
                  </div>
              ...
              >
                ...
                >
                  ...
                  <h2 style="font-size: 32px">
                    {{ dead[dead.length - 1]['ndeaths'] }} 人
                  </h2>
                  <h3 style="font-size: 24px">
                    前日比：＋
                    {{
                      dead[dead.length - 1]['ndeaths'] -
                      dead[dead.length - 2]['ndeaths']
                    }}
                    人
                  </h3>
                  <h3 style="font-size: 24px">
              ...
              >
                ...
                >
                  ...
                  <h2 style="font-size: 32px">
                    {{
                      Math.round(
                        (pcr[pcr.length - 1]['adpatients'] /
                          (pcr[pcr.length - 1]['npatients'] +
                            pcr[pcr.length - 1]['adpatients'])) *
                          100000
                      ) / 100
                    }}
                  ...
                  <h3 style="font-size: 24px">
                    前日：{{
                      Math.round(
                        (pcr[pcr.length - 2]['adpatients'] /
                          (pcr[pcr.length - 2]['npatients'] +
                            pcr[pcr.length - 2]['adpatients'])) *
                          100000
                      ) / 100
                    }}
                  ...
                  <h3 style="font-size: 24px">
                    前々日：{{
                      Math.round(
                        (pcr[pcr.length - 3]['adpatients'] /
                          (pcr[pcr.length - 3]['npatients'] +
                            pcr[pcr.length - 3]['adpatients'])) *
                          100000
                      ) / 100
                    }}
